...
class HomeContent extends Model
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'activities_tag' => 'More than a game drive',
            'activities_title' => 'Four experiences worth <em>building a trip around</em>',
            'activities_lede' => 'The things travelers remember most, across all three trips.',
            'activities' => [
                [
                    'image' => 'images/gal-lion.jpg',
                    'tag' => 'Serengeti · Ngorongoro',
                    'eyebrow' => 'Dawn & dusk drives',
                    'title' => 'Game drives',
                    'text' => 'Private drives through Tarangire, the Serengeti plains and Ngorongoro Crater, timed to where the migration and the big cats actually are that week.',
                ],
                [
                    ...
                    'text' => "A chef-prepared meal laid out under the acacias as the sky turns orange over the plains — dessert comes with more stars than you've ever seen.",
                ],
                [
                ...
                [
                    ...
                    'title' => 'The coastal wind-down',
                    'text' => 'Dhow cruises, spice farm tours and Stone Town alleys, ending with dinner on the sand as the sun drops into the Indian Ocean.',
                ],
            ],
